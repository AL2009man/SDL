...
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_LEGACY         0x1101 // Legacy Steam Controller (CHELL)
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_WIRED          0x1102 // wired Steam Controller (D0G)
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_BLUETOOTH      0x1105 // Bluetooth Steam Controller (D0G)
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_BLUETOOTH2     0x1106 // Bluetooth Steam Controller (D0G)
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_WIRELESS       0x1142 // wireless Steam Controller
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_V2_WIRED       0x1201 // wired Steam Controller (HEADCRAB)
#define USB_PRODUCT_VALVE_STEAM_CONTROLLER_V2_BLUETOOTH   0x1202 // Bluetooth Steam Controller (HEADCRAB)
#define USB_PRODUCT_VALVE_STEAM_DECK_CONTROLLER           0x1205
